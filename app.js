...
const web3 = new Web3(`https://goerli.infura.io/${process.env.PROJECT_ID}`)

const accountAddress = process.env.ACCOUNT1 // Your account address 1
...
const contractOwner = '0x0a8ba09a8ecaa62073777916ea0034f0d04b29e6'
const contractaddress = process.env.CONTRACT_ADDRESS
const host = process.env.API_URL
// abi and bytecode genrated from contract

const contractJsonPath = path.resolve(__dirname,'./build/contracts','DA.json')
const contractJson = JSON.parse(fs.readFileSync(contractJsonPath))
const contractAbi = contractJson.abi
const contractBytecode = contractJson.bytecode

// console.log("contractBytecode is:", contractBytecode)
...
async function getValueAtAddress(host, deployedContractAbi, deployedContractAddress){
  ...
  const res = await contractInstance.isOwner
